...
class BudgetRepository(private val budgetDao: BudgetDao) {
     ...
     * enforced atomically by [BudgetDao.insertUnique] rather than via a DB constraint, since
     * SQLite's UNIQUE index treats distinct NULLs as non-duplicates, which would let multiple
     * Overall Budgets slip through.
     */
    suspend fun create(
        category: String?,
